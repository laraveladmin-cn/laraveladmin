                ...
                <edit :options="options" ref="edit">
                    <template slot="content" slot-scope="props">
                        <div class="move-items col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <edit-item key-name="name" :options="{name: props.transField('Sponsor'),type:'text', rules:'required|alpha_dash',title:''}" :datas="props">
                            </edit-item>
                            <edit-item key-name="url" :options="{name: props.transField('Link'),type:'url', rules:'required|url',title:''}" :datas="props">
                            ...
                            <edit-item key-name="logo" :options="{name: props.transField('Logo Icon'),type:'upload', rules:'required|url',title:''}" :datas="props">
                                <template slot="input-item">

                ...
                <edit :options="options">
                    <template slot="content" slot-scope="props">
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <edit-item key-name="name" :options="{name: '名称', required: true,disabled:true}"  :datas="props">
                            </edit-item>
                            <edit-item key-name="key" :options="{name: '键', required: true,disabled:true}"  :datas="props">
                            </edit-item>
                            <edit-item key-name="type" :options='{"name": "类型", "required": false,"type":"select"}' :datas="props">
                                <template slot="input-item">
                                    <div class="edit-item-content">
                                        <select2 v-model="props.data.row['type']"
                                                 :disabled="'disabled'"
                                                 :default-options="props.data.maps['type']"
                                                 :placeholder="false"
                                                 :is-ajax="false" >
                                        </select2>
                                    </div>
                            ...
                            <edit-item key-name="itype" :options='{"name": "输入框类型", "required": false,"type":"select"}' :datas="props">
                                <template slot="input-item">
                                    <div class="edit-item-content">
                                        <select2 v-model="props.data.row['itype']"
                                                 :disabled="'disabled'"
                                                 :default-options="props.data.maps['itype']"
                                                 :placeholder="false"
                                                 :is-ajax="false" >
                                        </select2>
                                    </div>
                            ...
                            <edit-item key-name="description" :options="{name: '描述', required: false,type:'textarea'}"  :datas="props">
                            </edit-item>
                        </div>

...
$str = <<<'str'
{
    ...
    "attributes": {
        ...
        "file": "File",
        "order": "Ordinamento",
        "where": "Condizioni di screening",
        "verify": "Codice di verifica"
    },
    "ckeck_password": ": attributo errato.",
    "mobile_phone": ": attributo errato.",
    "array_keys_in_array": "Attributo selezionato: attributo illegale.",
    "array_in_array": "Attributo selezionato: attributo illegale.",
    "sting_or_array": "Attributo selezionato: attributo illegale.",
    "url_path": ": il formato attributo non è corretto.",
    "captcha": ": errore di convalida degli attributi.",
    "user_name": "L'attributo deve essere un numero non puro composto da lettere, numeri e sottolineature.",
    "domain": ": attributo deve essere un nome di dominio valido.",
    "is_idcard": "L'attributo deve essere un numero ID valido."
}
str;
